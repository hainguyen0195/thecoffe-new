<?php
    ...
    $config['static'][$nametype]['info_more'] = array();
    ...
    $config['static'][$nametype]['width'] = 330;
    $config['static'][$nametype]['height'] = 510;
    $config['static'][$nametype]['images2'] = true;
    $config['static'][$nametype]['width2'] = 220;
    $config['static'][$nametype]['height2'] = 340;
