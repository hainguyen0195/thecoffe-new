		...
		<div class="row">
			...
			<div class="<?=$colRight?>">
				<?php if(
					...
					<?php if(isset($config['product'][$type]['thuoctinh']) && $config['product'][$type]['thuoctinh'] == true) { ?>
						<div class="card card-primary card-outline text-sm">
							<div class="card-header">
		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php } ?>
					<?php  if(isset($config['product'][$type]['info_more']) && $config['product'][$type]['info_more']!='' ) { ?>
						<?php  foreach($config['product'][$type]['info_more'] as $key_ifm => $value_inf) {  ?>
							<div class="form-group col-md-4 col-sm-6">
								<label for="<?=$key_ifm?>"><?=$value_inf?>:</label>
								<input type="text" class="form-control" name="data[info_more][<?=$key_ifm?>]" id="<?=$key_ifm?>" placeholder="<?=$value_inf?>" value="<?= (isset($info_more[$key_ifm]) && $info_more[$key_ifm] != '') ? $info_more[$key_ifm] : '' ?>">
							</div>
						<?php } ?>
					<?php } ?>
				</div>
