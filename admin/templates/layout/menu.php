...
<aside class="main-sidebar sidebar-dark-primary elevation-4 text-sm">
    ...
    <a class="brand-link" href="index.php">
        <img class="brand-image" src="../assets/images/logo.png" alt="icon" style="max-height: 55px;">
    </a>
                                ...
                                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        foreach($value['places'] as $k) {
                                            ...
                                            <li class="nav-item <?=$none?>">
                                                <a class="nav-link <?=$active?>" href="index.php?com=places&act=<?=$k?>" title="<?=$v['title_main']?>"><i class="nav-icon text-sm far fa-caret-square-right"></i><p><?=$v['title_main']?></p></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </li>
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if(isset($config['user']['visitor']) && $config['user']['visitor'] == true) {
                                    ...
                                    <li class="nav-item"><a class="nav-link <?=$active?>" href="index.php?com=user&act=man" title="Tài khoản trang index"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Tài khoản trang index</p></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    <?php } ?>
