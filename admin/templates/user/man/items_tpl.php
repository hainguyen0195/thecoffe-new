                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                             ...
                             <td class="align-middle">
                                <?php 
                                if($items[$i]['cuahang']==0){
                                    echo'Tổng công ty';
                                }else{
                                    $infocuahang = $d->rawQueryOne("select tenvi,  id from #_news where id = ? and  type = ? and hienthi > 0 order by stt,id asc",array($items[$i]['cuahang'],'cua-hang'));
                                    echo $infocuahang['tenvi'];
                                }
                                ?>
                            </td>
