		...
		<?php for($i=0;$i<$numberPhoto;$i++) { $stt = $i+1; ?>
			<div class="card card-primary card-outline text-sm">
	            ...
	            <div class="card-body">
		            ...
		            <?php } ?>
		            <?php if(isset($config['photo']['man_photo'][$type]['soluong']) && $config['photo']['man_photo'][$type]['soluong'] == true) { ?>
		                <div class="form-group">
		                    <label for="soluong<?=$i?>">Số lượng:</label>
		                    <input type="text" class="form-control" name="dataMulti[<?=$i?>][soluong]" id="soluong<?=$i?>" placeholder="Số lượng">
		                </div>
		            <?php } ?>
